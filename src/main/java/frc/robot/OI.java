...
drivestick = new Joystick(5);
        ...
        SmartDashboard.putData("RobotLevel", new RobotLevel());
        SmartDashboard.putData("BallIntake", new BallIntake());
        SmartDashboard.putData("MoveConveyer", new MoveConveyer());
        SmartDashboard.putData("BallOutput", new BallOutput());
        SmartDashboard.putData("ConveyerMaster", new ConveyerMaster());
